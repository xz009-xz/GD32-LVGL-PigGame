...
void create_login_ui(void)
{
    ...
    lv_obj_set_size(login_panel, 820, 480);
    lv_obj_center(login_panel);
    lv_obj_set_style_bg_color(login_panel, lv_color_hex(0xC0C0C0), 0);
    ...
    lv_label_set_text(title, "PIG FARMING GAME");
    ...
    lv_obj_align(username_ta, LV_ALIGN_TOP_MID, 0, 130);
    ...
    lv_obj_align(pass_label, LV_ALIGN_TOP_MID, 0, 200);

    password_ta = lv_textarea_create(login_panel);
    lv_obj_set_size(password_ta, 360, 45);
    lv_obj_align(password_ta, LV_ALIGN_TOP_MID, 0, 230);
    ...
    lv_obj_align(remember_btn, LV_ALIGN_TOP_LEFT, 170, 305);
    ...
    lv_obj_align(login_btn, LV_ALIGN_BOTTOM_LEFT, 140, -30);
    ...
    lv_obj_align(reg_btn, LV_ALIGN_BOTTOM_RIGHT, -140, -30);
